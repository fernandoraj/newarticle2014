...
to XX.XX\% over naive strategy and YY.YY\% over a temporal correlation approach,
...
in Naive approach it is virtually $0$), the average of number of messages is
$98.95\%$ smaller and the number of exchanged messages $75.85\%$ smaller in
average, compared to Naive. When compared to Adaga-P*, the average RMSE
of BCWSN-FC-CH approach is $6.77\%$ ($0.0288$) smaller, while the average of
number of messages is $90.4\%$ smaller.
