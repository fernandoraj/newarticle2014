...
and light), which in turn is computed from the time series
...
This monitoring application simulates the gathering of one variable from the
...
$6.3\%$ higher in average than the RMSE presented by Adaga-P*.
\vspace*{-.3cm}
