...
our case the sink only receives data from sensors that read novelties to determine their 
...
similar to another approach (Adaga-P*  \cite{MaiaSAC2013, MaiaACR2013}), while the 
